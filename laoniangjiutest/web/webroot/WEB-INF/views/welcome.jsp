...
<html>
<head>
    <title>Welcome to laoniangjiutest</title>
    <link rel="stylesheet" href="<c:url value="/static/laoniangjiutest-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "laoniangjiutest" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/laoniangjiutest-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/laoniangjiutest-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/laoniangjiutest-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/laoniangjiutest-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/laoniangjiutest-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
