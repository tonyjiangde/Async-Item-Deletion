...
public class DefaultLaoniangjiutestService implements LaoniangjiutestService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultLaoniangjiutestService.class);
	...
	{
		return DefaultLaoniangjiutestService.class.getResourceAsStream("/laoniangjiutest/sap-hybris-platform.png");
	}
